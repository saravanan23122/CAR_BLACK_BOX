    ...
    while(count < 5)
    {
        ...
        if(enter ==0)
        {
            if(wait++ == 800)
            {
                ...
                if(cursor_flag ==0)
                {
                    clcd_putch('_',(0xC0 + (4+count)));
                }
                else
                {
                    clcd_putch(' ',(0xC0 + (4+count)));
                }
        ...
        else if(check ==1 && count == 4)
        {
            if(chance < 3)
            {
                clcd_print(" WRONG_PASSWORD ",(0x80 + (0)));
                clcd_print("  Attempts left ",(0xC0 + (0)));
                clcd_putch(51-chance,(0xC0 + (0)));
                enter =0;
                count=0;
                success =0;
                check=0;
...
void display_menu_screen()
{
    clcd_print("    VIEW_LOG    ",(0x80 + (0)));
    clcd_print("     SET_LOG    ",(0xC0 + (0)));
